...
/// Manages on-disk caching of food photos, keyed by `FoodLog.id`.
///
/// - Images are stored as square-cropped JPEGs under Documents/food_images.
/// - Filenames are deterministic: "<log.id>.jpg".
final class FoodImageStore {
    ...
    /// Returns the filename (lastPathComponent) or nil on failure.
    @discardableResult
...
extension UIImage {
    /// Center-crop to a square around the middle of the image.
