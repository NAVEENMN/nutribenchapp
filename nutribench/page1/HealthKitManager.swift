...
final class HealthKitManager {
    ...
    /// Returns a DBClient.HealthSummary via completion.
    func dailySummary(for day: Date, completion: @escaping (Result<DBClient.HealthSummary, Error>) -> Void) {
        ...
        group.notify(queue: .global(qos: .userInitiated)) {
            ...
            let summary = DBClient.HealthSummary(
                dateISO8601: iso,
                steps: steps,
